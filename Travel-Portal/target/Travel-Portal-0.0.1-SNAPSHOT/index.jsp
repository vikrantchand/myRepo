			...
			<article class="col1">
				<div class="box1">
					...
					<article class="col2">
						...
						<div class="wrapper">
							<article class="cols">
								<figure><img src="static/images/page1_img1.jpg" alt="" class="pad_bot2"></figure>
							...
							<article class="cols pad_left1">
								<figure><img src="static/images/page1_img2.jpg" alt="" class="pad_bot2"></figure>
				...
				<div class="wrapper">
					<ul id="icons">
						<li><a href="#" class="normaltip" title="Facebook"><img
								src="static/images/icon1.jpg" alt=""></a></li>
						<li><a href="#" class="normaltip" title="Delicious"><img
								src="static/images/icon2.jpg" alt=""></a></li>
						<li><a href="#" class="normaltip" title="Stumble Upon"><img
								src="static/images/icon3.jpg" alt=""></a></li>
						<li><a href="#" class="normaltip" title="Twitter"><img
								src="static/images/icon4.jpg" alt=""></a></li>
						<li><a href="#" class="normaltip" title="Linkedin"><img
								src="static/images/icon5.jpg" alt=""></a></li>
						<li><a href="#" class="normaltip" title="Reddit"><img
								src="static/images/icon6.jpg" alt=""></a></li>
					</ul>
					<div class="links">
						<a rel="nofollow" href="http://www.templatemonster.com/"
							target="_blank">Website template</a> designed by
						TemplateMonster.com<br> <a
							href="http://www.templates.com/product/3d-models/"
							target="_blank">3D Models</a> provided by Templates.com
					</div>
				</div>
			</footer>
			<!--footer end-->
